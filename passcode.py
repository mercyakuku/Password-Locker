...
class User:
    ...
    # Created a User class that generates new instances of a user.
...
class Credentials():
    ...
    # Created credentials class to help create new objects of credentials
    
    credentials_list = []
    @classmethod
    def verify_user(cls,username, password):
        
        # Method to verify whether the user is in the user_list or not
    ...
    def if_credential_exist(cls, account):
        ...
        # Method that checks if a credential exists from the credential list and returns true or false  if the credential exists or not.
    ...
    def display_credentials(cls):
        ...
        # Method that returns all accounts in the credentials list
